                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="input-group date">
                                    ...
                                    <input type="text" name="date" class="form-control datepicker2" value="{{ date('m/d/Y') }}">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="input-group clockpicker" data-autoclose="true">
                                <span class="input-group-addon">
                                    <span class="fa fa-clock-o"></span>
                                </span><input type="text" class="form-control" value="{{ old('end_time_tweet') ? old('end_time_tweet') : '22:30' }}" name="end_time_tweet">
                            </div>
                        </div>
                    </div>
                    <div class="row">
