    ...
    {!! Session::get('message') !!}
        <div class="card">
           <div class="header">
            ...
            <div class="content">
                <form method="POST" action="{{ action('KlasifikasiController@preprocessing') }}">
                    {!! csrf_field() !!}
					...
					<div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="input-group clockpicker" data-autoclose="true">
                                <span class="input-group-addon">
                                    <span class="fa fa-clock-o"></span>
                                </span><input type="text" class="form-control" value="{{ old('end_time_tweet') ? old('end_time_tweet') : '23:30' }}" name="end_time_tweet">
                            </div>
                        </div>
                    </div>
